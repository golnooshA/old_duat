...
def test():
    ...
    pred_depths = []
    # print("xxxxxxxxxxxxxxxxx",pred_filenames)
    ...
    # print("pppppp",len(pred_depths))
    # print("pppppp",(pred_depths[0].shape))
    ...
    if args.dataset == 'kitti':
        for t_id in range(num_test_samples):
            ...
            gt_depth_path = os.path.join(args.gt_path, filename + '.png')
    ...
    # print("ggggg",len(gt_depths))
    # print("ggggg",(gt_depths[0].shape))
