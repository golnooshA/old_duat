...
start_epoch = 0
generator_checkpoint = os.path.join(SAVE_DIR, 'generator_epoch_210.pth')
discriminator_checkpoint = os.path.join(SAVE_DIR, 'discriminator_epoch_210.pth')
optimizer_checkpoint = os.path.join(SAVE_DIR, 'optimizer_epoch_210.pth')
...
if os.path.exists(generator_checkpoint) and os.path.exists(discriminator_checkpoint) and os.path.exists(optimizer_checkpoint):
    ...
    print("Resuming from checkpoint at epoch 210.")
    start_epoch = 210
else:
